    ...
    function defineLeafletLoading(L) {
        L.Control.Loading = L.Control.extend({
            ...
            _getLastControlButton: function () {
                var container = this.zoomControl._container, index = container.children.length - 1;
...
class NgxLoadingControlComponent {
    constructor() {
    ...
    ngOnDestroy() {
        var _a;
        (_a = this._map) === null || _a === void 0 ? void 0 : _a.removeControl(this.loading);
    }
    set map(map) {
        if (map) {
            this._map = map;
...
class NgxLoadingControlModule {
}
NgxLoadingControlModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.3.8", ngImport: i0, type: NgxLoadingControlModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
NgxLoadingControlModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.3.8", ngImport: i0, type: NgxLoadingControlModule, declarations: [NgxLoadingControlComponent], exports: [NgxLoadingControlComponent] });
NgxLoadingControlModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.3.8", ngImport: i0, type: NgxLoadingControlModule, imports: [[]] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.8", ngImport: i0, type: NgxLoadingControlModule, decorators: [{
            type: NgModule,
            args: [{
...
export { NgxLoadingControlComponent, NgxLoadingControlModule };
//# sourceMappingURL=runette-ngx-leaflet-loading.mjs.map
