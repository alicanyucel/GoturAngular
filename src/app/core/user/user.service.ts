...
export class UserService {
    ...
    private _roles: ReplaySubject<Array<string>> = new ReplaySubject<Array<string>>();
    private _permissions: ReplaySubject<Array<string>> = new ReplaySubject<Array<string>>();
