...
import { CarrierApplicationService, ICreateCarrierRegistryRequestCommand } from './application-form.service';
...
@Component(
	{
		selector: 'app-carrier-application-form',
...
export class ApplicationFormComponent implements OnInit {
	...
	constructor(
		...
		private _service: CarrierApplicationService,
	...
	async onSubmit(): Promise<void> {
		...
		try {
			await this._service.postCarrierApplication(<ICreateCarrierRegistryRequestCommand><unknown>this.applicationForm.value)
